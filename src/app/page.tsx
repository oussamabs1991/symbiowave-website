...
import { SymbioWaveLogo } from '@/components/icons/SymbioWaveLogo.tsx';
import { motion, animate, AnimatePresence } from 'framer-motion';
import { useEffect, useRef, useState } from 'react';
import ModelCard from '@/components/ui/ModelCard.tsx';
import DivisionCard from '@/components/ui/DivisionCard.tsx';
import EcosystemDiagram from '@/components/feature/EcosystemDiagram.tsx';
import PhysarumIcon from '@/components/icons/models/PhysarumIcon.tsx';
import QuorumIcon from '@/components/icons/models/QuorumIcon.tsx';
import ImmuneIcon from '@/components/icons/models/ImmuneIcon.tsx';
import NeuralCrestIcon from '@/components/icons/models/NeuralCrestIcon.tsx';
import BioElectricSignalIcon from '@/components/icons/models/BioElectricSignalIcon.tsx';
import GeneticAlgorithmIcon from '@/components/icons/models/GeneticAlgorithmIcon.tsx';
import SwarmIntelligenceIcon from '@/components/icons/models/SwarmIntelligenceIcon.tsx';
import MycelialNetworkIcon from '@/components/icons/models/MycelialNetworkIcon.tsx';
import BacterialForagingIcon from '@/components/icons/models/BacterialForagingIcon.tsx';
import EcologicalNicheIcon from '@/components/icons/models/EcologicalNicheIcon.tsx';
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <motion.section
        id="aci-showcase"
        className="py-16 md:py-24 bg-neutral-dark/30"
        initial={{ opacity: 0 }}
      ...
      <motion.section
        id="ecosystem"
        className="py-16 md:py-24 bg-neutral-dark/50"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 md:mt-12 min-h-[280px] md:min-h-[240px]">
            <AnimatePresence mode="wait">
              {activeDivisionDetails ? (
                <motion.div
                  key={activeDivisionDetails.id}
                ...
                >
                  <DivisionCard
                    ...
                    className="border border-secondary-medium/50 shadow-secondary-medium/20"
                  />
                </motion.div>
              ) : (
                <motion.div
                  key="all-divisions-grid"
                  initial="hidden"
                  animate="visible"
                  exit={{ opacity: 0 }}
                  variants={{
      ...
      <motion.section
        id="about"
        className="py-16 md:py-24 bg-neutral-dark/40"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      <motion.section
        id="technology"
        className="py-16 md:py-24 bg-primary-deep/10"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.1 }}
      ...
      <motion
        ...
        id="contact"
        className="py-16 md:py-24 bg-neutral-dark/60"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.1 }}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-10">
            <motion.p
              className="text-lg text-center text-neutral-light/80 mb-10 max-w-2xl mx-auto"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}
              viewport={{ once: true, amount: 0.3 }}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              ...
              { label: "Resources Optimized (USD)", value: 570, prefix: "$", suffix: "M+" },
              { label: "CO2 Emissions Reduced (Tons)", value: 800, suffix: "K+" },
              ...
              >
                <AnimatedCounter
                  ...
                  className="text-4xl md:text-5xl font-bold text-accent-purple"
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  key={story.id}
                  className="bg-neutral-medium/40 p-6 rounded-lg shadow-md hover:shadow-primary-light/20 transition-shadow duration-300 flex flex-col justify-between"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  viewport={{ once: true, amount: 0.3 }}
                >
                  ...
                  <a href={story.link} className="text-primary-light hover:underline mt-auto inline-block text-xs font-semibold self-start">
